...
function layout_sidebar_change(value) {
  if (value == "dark") {
    document
      ...
      .setAttribute("data-pc-sidebar-theme", "dark");
    if (document.querySelector(".pc-sidebar .m-header .logo-lg")) {
      document
        .querySelector(".pc-sidebar .m-header .logo-lg")
        .setAttribute("src", "/build/images/logo-dark.png");
    }
    var control = document.querySelector(".theme-sidebar-color .btn.active");
    if (control) {
      document
        .querySelector(".theme-sidebar-color .btn.active")
        .classList.remove("active");
      document
        .querySelector(".theme-sidebar-color .btn[data-value='true']")
        .classList.add("active");
    }
  } else {
    document
      .getElementsByTagName("body")[0]
      .setAttribute("data-pc-sidebar-theme", "light");
    if (document.querySelector(".pc-sidebar .m-header .logo-lg")) {
      document
        .querySelector(".pc-sidebar .m-header .logo-lg")
        .setAttribute("src", "/build/images/logo-dark.png");
    ...
    if (control) {
      document
        ...
        .classList.remove("active");
      document
        .querySelector(".theme-sidebar-color .btn[data-value='false']")
        .classList.add("active");
    }
  }
}
  ...
  if (layout == "dark") {
    ...
    if (document.querySelector(".landing-logo")) {
      document
        ...
        .setAttribute("src", "assets/images/logo-dark.png");
    }
