    ...
    pc_link_click[i].addEventListener('click', function (event) {
      ...
      if (targetElement.parentNode.classList.contains('pc-trigger')) {
        ...
        window.setTimeout(() => {
          ...
          targetElement.parentNode.children[1].style.display = '    ';
        }, 200);
      } else {
...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', '/build/images/logo-dark.png');
}
...
function layout_sidebar_change(value) {
  if (value == 'dark') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '/build/images/logo-dark.png');
    }
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '/build/images/logo-dark.png');
    }
    if (document.querySelector('.landing-logo')) {
      document.querySelector('.landing-logo').setAttribute('src', 'assets/images/logo-dark.png');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '/build/images/logo-dark.png');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '/build/images/logo-dark.png');
    }
    ...
    if (document.querySelector('.landing-logo')) {
      document.querySelector('.landing-logo').setAttribute('src', '/build/images/logo-dark.png');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '/build/images/logo-dark.png');
    }
